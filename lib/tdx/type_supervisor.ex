defmodule Tdx.TypeSupervisor do
    @moduledoc false
  
    use Supervisor
  
    @manager Tdx.TypeManager
    @supervisor Tdx.TypeSupervisor
    ...
    defp start_server(module, pair) do
      opts = [name: {:via, Registry, {Tdx.TypeManager, pair}}]
  
      case DynamicSupervisor.start_child(@supervisor, {Tdx.TypeServer, {module, self(), opts}}) do
        {:ok, pid} -> pid
