defmodule Tdx.Utils do
  ...
  def default_opts(opts) do
    ...
    |> Keyword.put_new(:database, System.get_env("MSSQLDATABASE"))
    |> Keyword.put_new(:instance, System.get_env("MSSQLINSTANCE"))
    |> Keyword.put_new(:hostname, System.get_env("MSSQLHOST") || "10.0.3.222")
    |> Keyword.update(:port, normalize_port(System.get_env("MSSQLPORT")), &normalize_port/1)
